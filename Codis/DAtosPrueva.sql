...
UPDATE COMENTARI
SET text = 'Modificar comentario hecho de la ruta.', feta = 0 , dificultat = 10, valoracio_paisatge = NULL, valoracio_seguretat = NULL
...
-- No dona error perque o modifica directament amb el trigger 
INSERT INTO COMENTARI (usu_login, id_ruta, text, valoracio_informacio, feta, dificultat, valoracio_paisatge, valoracio_seguretat, moment_temp)
